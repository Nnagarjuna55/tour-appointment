...
const Layout: React.FC = () => {
    ...
    const adminNavigation = [
        ...
        { name: 'Create Booking', href: '/admin/booking', icon: UserCheck },
        { name: 'All Appointments', href: '/admin/appointments', icon: Calendar },
        { name: 'User Management', href: '/admin/users', icon: Users },
        { name: 'Museum Config', href: '/admin/museum-config', icon: Building },
    ];
            ...
            <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
                ...
                <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
                    <div className="flex h-16 items-center justify-between px-4">
                        <h1 className="text-xl font-bold text-gray-900">Museum Booking</h1>
                        <button
