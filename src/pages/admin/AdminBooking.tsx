                        ...
                        <div className="border-b border-gray-200">
                            <nav className="-mb-px flex space-x-8">
                                <button
                                    ...
                                    className={`py-2 px-1 border-b-2 font-medium text-sm ${bookingMode === 'manual'
                                ...
                                <button
                                    ...
                                    className={`py-2 px-1 border-b-2 font-medium text-sm ${bookingMode === 'auto'
                                        ? 'border-blue-500 text-blue-600'
                                        : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                        }`}
                                >
                                    Auto Booking (CSV Upload)
                                </button>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="border-b border-gray-200 pb-4">
                                                ...
                                                <div className="mt-2 text-sm text-gray-600">
                                                    ...
                                                    <p><strong>Date:</strong> {formData.visitDate && isValidDate(formData.visitDate) ? format(new Date(formData.visitDate), 'MMMM dd, yyyy') : 'Not selected'}</p>
